      ...
      <div className="container-custom">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 animate-fade-up">
          <div className="inline-flex items-center gap-2 bg-secondary/10 px-4 py-2 rounded-full mb-6">
            ...
            <span className="text-secondary text-sm font-semibold">Nossos serviços</span>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {services.map((service, index) => (
            ...
            >
              <div className={`w-14 h-14 ${service.color}/10 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}>
                <service.icon className={`w-7 h-7 ${service.color === 'bg-primary' ? 'text-primary' : service.color === 'bg-secondary' ? 'text-secondary' : 'text-accent'}`} />
              </div>
